...
class RegionDetector {
  static const _locationRegionMap = {
    'kanto': [
      ...
      'mt-moon', 'cerulean-city', 'rock-tunnel', 'power-plant',
      'lavender-town', 'pokemon-tower', 'saffron-city', 'celadon-city',
      'vermilion-city', 'digletts-cave', 'fuchsia-city', 'seafoam-islands',
      'cinnabar-island', 'victory-road', 'indigo-plateau', 'tohjo-falls',
    ],
    'johto': [
      'new-bark-town', 'cherrygrove-city', 'violet-city', 'dark-cave',
      'ruins-of-alph', 'union-cave', 'azalea-town', 'ilex-forest',
      'goldenrod-city', 'national-park', 'ecruteak-city', 'burned-tower',
      'bell-tower', 'tin-tower', 'olivine-city', 'mahogany-town',
      'lake-of-rage', 'ice-path', 'blackthorn-city', 'dragons-den',
      'cianwood-city', 'whirl-islands', 'mt-mortar', 'mt-silver',
    ],
    'hoenn': [
      ...
      'meteor-falls', 'mt-chimney', 'jagged-pass', 'fiery-path',
      'mt-pyre', 'shoal-cave', 'cave-of-origin', 'sky-pillar',
    ],
    'sinnoh': [
      'twinleaf-town', 'lake-verity', 'sandgem-town', 'jubilife-city',
      'canalave-city', 'iron-island', 'floaroma-town', 'eterna-city',
      'hearthome-city', 'solaceon-town', 'veilstone-city', 'pastoria-city',
      'great-marsh', 'celestic-town', 'mt-coronet', 'snowpoint-city',
      'lake-acuity', 'sunyshore-city', 'pokemon-league', 'oreburgh-city',
      'oreburgh-mine', 'ravaged-path', 'valley-windworks', 'eterna-forest',
    ],
    'unova': [
      ...
      'black-city', 'white-forest', 'aspertia-city', 'virbank-city',
      'humilau-city', 'lentimas-town', 'reversal-mountain', 'twist-mountain',
      'chargestone-cave', 'wellspring-cave', 'celestial-tower', 'dragonspiral-tower',
    ],
    'kalos': [
      ...
      'anistar-city', 'couriway-town', 'snowbelle-city', 'terminus-cave',
      'reflecting-cave', 'connecting-cave', 'glittering-cave', 'frost-cavern',
    ],
  };
  ...
  static String? detectRegion(String locationName) {
    ...
    for (final entry in _locationRegionMap.entries) {
      for (final location in entry.value) {
        if (normalizedName.contains(location) || location.contains(normalizedName)) {
          return entry.key;
        }
      }
    }
